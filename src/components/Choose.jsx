          ...
          <div className="choose__content">
            ...
            <div className="choose__features">
              <ChooseFeature
                ...
                paragraph="Take your driving experience to the next level with our
                    top-notch vehicles for your cross-country adventures."
              />
              <ChooseFeature
                image={Choose2}
                title="All Inclusive Pricing"
                paragraph="TGet everything you need in one convenient, transparent price with our all-inclusive pricing policy."
              />
              <ChooseFeature
                image={Choose3}
